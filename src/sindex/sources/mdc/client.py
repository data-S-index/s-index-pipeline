...
def make_duckdb_conn(db_path: str, *, read_only: bool = False) -> duckdb.DuckDBPyConnection:
...
def register_mdc_udfs(con: duckdb.DuckDBPyConnection) -> None:
    ...
    con.create_function("norm_doi_url_or_raw", norm_doi_url_or_raw, ["VARCHAR"], "VARCHAR")
